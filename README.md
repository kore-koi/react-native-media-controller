...
- [`android/`](android): All your `android`-specific implementations.
  ...
  - [`src/main/java/com/margelo/nitro/mediacontroller/`](android/src/main/java/com/margelo/nitro/mediacontroller/): All Kotlin implementations.
    - [`<<androidCxxLibName>>Package.java`](android/src/main/java/com/margelo/nitro/mediacontroller/<<androidCxxLibName>>Package.java): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.java` file. In here, you can autolink all Kotlin HybridObjects.
